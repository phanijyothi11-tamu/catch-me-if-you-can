...
#SBATCH --job-name=MAD-TSC-PT   # Sets the job name to AbaqusJob
...
mkdir -p "$DATA_SCRATCH/$UUID/MAD_TSC_pt"
...
--dataset-config configs/datasets/MAD_TSC_pt.json \
--gpu-pl-config configs/lightning/default_lightning_config.json \
--sub-path-final-folder run_outputs/pt_spc \
