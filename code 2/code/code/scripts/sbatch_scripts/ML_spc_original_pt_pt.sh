...
#SBATCH --job-name=ML_spc_original_pt_pt
...
echo "[INFO] Training SPC model on original/pt with model xlm-roberta-base"

# Launch training
tscbench finetune tsc \
-n ML_spc_original_pt_pt \
-m "xlm-roberta-base" \
-t "xlm-roberta-base" \
...
--sub-path-final-folder run_outputs/ML_original_pt_pt_spc \
