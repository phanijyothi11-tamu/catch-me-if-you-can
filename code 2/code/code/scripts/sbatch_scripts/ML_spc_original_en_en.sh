...
#SBATCH --job-name=ML_spc_original_en_en
...
echo "[INFO] Training SPC model on original/en with model xlm-roberta-base"

# Launch training
tscbench finetune tsc \
-n ML_spc_original_en_en \
-m "xlm-roberta-base" \
-t "xlm-roberta-base" \
...
--sub-path-final-folder run_outputs/ML_original_en_en_spc \
