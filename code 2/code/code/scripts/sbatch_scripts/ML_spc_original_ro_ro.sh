...
#SBATCH --job-name=ML_spc_original_ro_ro
...
echo "[INFO] Training SPC model on original/ro with model xlm-roberta-base"

# Launch training
tscbench finetune tsc \
-n ML_spc_original_ro_ro \
-m "xlm-roberta-base" \
-t "xlm-roberta-base" \
...
--sub-path-final-folder run_outputs/ML_original_ro_ro_spc \
