...
#SBATCH --job-name=MAD-TSC-Dual-Encoder   # Sets the job name to AbaqusJob
...
#SBATCH --output=logs/job_dual_encoder.o%J  # Sends stdout and stderr to job.o[jobID]
...
python -u dual_encoder_fusion.py
