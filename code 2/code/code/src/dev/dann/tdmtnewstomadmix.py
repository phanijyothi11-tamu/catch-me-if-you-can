...
val_ds = SentData(mad_val, 0, use_mt=False)  # No MT for validation (original text)
...
for seed in SEEDS:
    ...
    print("Evaluating on MAD validation.")
    loss, macro, report = run_epoch(model, val_dl)
...
print("Testing on MAD test data (MT):")
print(f"Macro F1: {macro:.4f}")

loss, macro, report = run_epoch(model, rw_dl)
print("Testing on MAD test data (RW):")
print(f"Macro F1: {macro:.4f}")
