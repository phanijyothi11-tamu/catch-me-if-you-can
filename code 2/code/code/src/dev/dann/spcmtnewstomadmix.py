...
# Domain‑Adversarial BERT for Target‑Dependent Sentiment (News to MAD-TSC)
...
from transformers import XLMRobertaTokenizer, XLMRobertaModel  # Updated to XLM-RoBERTa imports
