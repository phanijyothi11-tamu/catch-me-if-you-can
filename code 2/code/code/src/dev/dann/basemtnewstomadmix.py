...
# Train on News, Test on MAD
train_ds = ConcatDataset([
    SentData(news_train, 1, use_mt=True)  # Use MT for News
])

val_ds = SentData(mad_val, 0, use_mt=False)  # No MT for MAD validation
test_ds = SentData(mad_test, 0, use_mt=False)  # No MT for MAD test
...
for seed in SEEDS:
    ...
    # Final model test on MAD test data
    print("Evaluating on MAD test.")
...
loss, macro, report = run_epoch(model, test_dl)
print("Testing on MAD test data:")
