...
optimizer = AdamW([
    {"params": model.parameters()},                  # BiLSTM and FC
    {"params": bert_model.parameters(), "lr": 2e-5}   # BERT fine-tune (small lr)
], lr=2e-4)

train_steps_per_epoch = len(train_data)
num_training_steps = train_steps_per_epoch * 30  # total steps = epochs * steps per epoch
