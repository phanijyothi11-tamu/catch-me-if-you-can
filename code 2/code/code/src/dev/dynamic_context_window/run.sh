...
#SBATCH --job-name=MAD-TSC-Context-Window   # Sets the job name to AbaqusJob
...
#SBATCH --output=job_trial4_xlm.o%J  # Sends stdout and stderr to job.o[jobID]
...
source /scratch/user/ps41/ws/nlp/priyal/priyal_venv/bin/activate 
 
# Set proxy
export http_proxy="http://10.73.132.63:8080"
export https_proxy="http://10.73.132.63:8080"

export HF_HOME=/scratch/user/ps41/hf_cache
