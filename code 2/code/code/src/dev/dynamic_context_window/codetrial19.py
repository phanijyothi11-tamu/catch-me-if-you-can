...
bert_model = AutoModel.from_pretrained("google/muril-base-cased").to(device)

# Freeze initially
for param in bert_model.parameters():
    param.requires_grad = False

# Unfreeze last two encoder layers and pooler
...
optimizer = AdamW([
    {"params": model.parameters(), "lr": 2e-4, "weight_decay": 0.01},
