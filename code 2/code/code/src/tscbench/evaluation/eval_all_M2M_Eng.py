...
experiments = [
    {
        "model_dir": "experiments/run_outputs/m2m12B_from_de_to_en_en_spc",
        "run_name": "spc_m2m12B_from_de_to_en_en_exp",
        "test_file": "data/MAD_TSC/original/en/test.jsonl",
        "ckpt_path": "experiments/run_outputs/m2m12B_from_de_to_en_en_spc/validation_loss_sg/infallible_blackburn#validation_loss_sg=0.6827.ckpt",  # update with actual ckpt filename
    },
    {
        "model_dir": "experiments/run_outputs/m2m12B_from_es_to_en_en_spc",
        "run_name": "spc_m2m12B_from_es_to_en_en_exp",
        "test_file": "data/MAD_TSC/original/en/test.jsonl",
        "ckpt_path": "experiments/run_outputs/m2m12B_from_es_to_en_en_spc/validation_loss_sg/nervous_grothendieck#validation_loss_sg=0.6159.ckpt",  # update
    },
    {
        "model_dir": "experiments/run_outputs/m2m12B_from_fr_to_en_en_spc",
        "run_name": "spc_m2m12B_from_fr_to_en_en_exp",
        "test_file": "data/MAD_TSC/original/en/test.jsonl",
        "ckpt_path": "experiments/run_outputs/m2m12B_from_fr_to_en_en_spc/validation_loss_sg/gracious_meitner#validation_loss_sg=0.6239.ckpt",  # update
    },
    {
        "model_dir": "experiments/run_outputs/m2m12B_from_it_to_en_en_spc",
        "run_name": "spc_m2m12B_from_it_to_en_en_exp",
        "test_file": "data/MAD_TSC/original/en/test.jsonl",
        "ckpt_path": "experiments/run_outputs/m2m12B_from_it_to_en_en_spc/validation_loss_sg/wizardly_mcnulty#validation_loss_sg=0.6141.ckpt",  # update
    },
    {
        "model_dir": "experiments/run_outputs/m2m12B_from_nl_to_en_en_spc",
        "run_name": "spc_m2m12B_from_nl_to_en_en_exp",
        "test_file": "data/MAD_TSC/original/en/test.jsonl",
        "ckpt_path": "experiments/run_outputs/m2m12B_from_nl_to_en_en_spc/validation_loss_sg/trusting_ritchie#validation_loss_sg=0.6835.ckpt",  # update
    },
    {
        "model_dir": "experiments/run_outputs/m2m12B_from_pt_to_en_en_spc",
        "run_name": "spc_m2m12B_from_pt_to_en_en_exp",
        "test_file": "data/MAD_TSC/original/en/test.jsonl",
        "ckpt_path": "experiments/run_outputs/m2m12B_from_pt_to_en_en_spc/validation_loss_sg/wizardly_mcnulty#validation_loss_sg=0.6100.ckpt",  # update
    },
    {
        "model_dir": "experiments/run_outputs/m2m12B_from_ro_to_en_en_spc",
        "run_name": "spc_m2m12B_from_ro_to_en_en_exp",
        "test_file": "data/MAD_TSC/original/en/test.jsonl",
        "ckpt_path": "experiments/run_outputs/m2m12B_from_ro_to_en_en_spc/validation_loss_sg/gracious_meitner#validation_loss_sg=0.5980.ckpt",  # update
    },
]



final_results_dir = "experiments/M2M_Eng_eval_collated_results"
