...
experiments = [
    {
        "model_dir": "experiments/run_outputs/m2m12B_from_en_to_de_de_spc",
        "run_name": "spc_m2m12B_from_en_to_de_de_exp",
        "test_file": "data/MAD_TSC/original/de/test.jsonl",
        "ckpt_path": "experiments/run_outputs/m2m12B_from_en_to_de_de_spc/validation_loss_sg/affectionate_bouman#validation_loss_sg=0.7574.ckpt",  # update with actual ckpt filename
    },
    {
        "model_dir": "experiments/run_outputs/m2m12B_from_en_to_es_es_spc",
        "run_name": "spc_m2m12B_from_en_to_es_es_exp",
        "test_file": "data/MAD_TSC/original/es/test.jsonl",
        "ckpt_path": "experiments/run_outputs/m2m12B_from_en_to_es_es_spc/validation_loss_sg/upbeat_feistel#validation_loss_sg=0.8241.ckpt",  # update
    },
    {
        "model_dir": "experiments/run_outputs/m2m12B_from_en_to_fr_fr_spc",
        "run_name": "spc_m2m12B_from_en_to_fr_fr_exp",
        "test_file": "data/MAD_TSC/original/fr/test.jsonl",
        "ckpt_path": "experiments/run_outputs/m2m12B_from_en_to_fr_fr_spc/validation_loss_sg/amazing_easley#validation_loss_sg=0.6946.ckpt",  # update
    },
    {
        "model_dir": "experiments/run_outputs/m2m12B_from_en_to_it_it_spc",
        "run_name": "spc_m2m12B_from_en_to_it_it_exp",
        "test_file": "data/MAD_TSC/original/it/test.jsonl",
        "ckpt_path": "experiments/run_outputs/m2m12B_from_en_to_it_it_spc/validation_loss_sg/fervent_hugle#validation_loss_sg=0.7595.ckpt",  # update
    },
    {
        "model_dir": "experiments/run_outputs/m2m12B_from_en_to_nl_nl_spc",
        "run_name": "spc_m2m12B_from_en_to_nl_nl_exp",
        "test_file": "data/MAD_TSC/original/nl/test.jsonl",
        "ckpt_path": "experiments/run_outputs/m2m12B_from_en_to_nl_nl_spc/validation_loss_sg/wizardly_mcnulty#validation_loss_sg=0.7956.ckpt",  # update
    },
    {
        "model_dir": "experiments/run_outputs/m2m12B_from_en_to_pt_pt_spc",
        "run_name": "spc_m2m12B_from_en_to_pt_pt_exp",
        "test_file": "data/MAD_TSC/original/pt/test.jsonl",
        "ckpt_path": "experiments/run_outputs/m2m12B_from_en_to_pt_pt_spc/validation_loss_sg/gracious_meitner#validation_loss_sg=0.7381.ckpt",  # update
    },
    {
        "model_dir": "experiments/run_outputs/m2m12B_from_en_to_ro_ro_spc",
        "run_name": "spc_m2m12B_from_en_to_ro_ro_exp",
        "test_file": "data/MAD_TSC/original/ro/test.jsonl",
        "ckpt_path": "experiments/run_outputs/m2m12B_from_en_to_ro_ro_spc/validation_loss_sg/distracted_knuth#validation_loss_sg=0.7576.ckpt",  # update
    },
]



final_results_dir = "experiments/M2M_TG_eval_collated_results"
