...
experiments = [
    {
        ...
        "validation_file": "data/MAD_TSC/m2m12B/from_en_to_de/test.jsonl",
        "ckpt_path": "experiments/run_outputs/de_bert_german/validation_loss_sg/distracted_knuth#validation_loss_sg=0.7868.ckpt",
    },
    {
        "model_dir": "experiments/run_outputs/es_plantl_spanish2",
        "run_name": "es_plantl_spanish2_run1_exp",
        "validation_file": "data/MAD_TSC/m2m12B/from_en_to_es/test.jsonl",
        "ckpt_path": "experiments/run_outputs/es_plantl_spanish2/validation_loss_sg/elastic_pike#validation_loss_sg=0.6413.ckpt",
    },
    {
        "model_dir": "experiments/run_outputs/fr_camembert_french",
        "run_name": "fr_camembert_french_run1_exp",
        "validation_file": "data/MAD_TSC/m2m12B/from_en_to_fr/test.jsonl",
    ...
    },
    {
        ...
        "validation_file": "data/MAD_TSC/m2m12B/from_en_to_it/test.jsonl",
    ...
    },
    {
        ...
        "validation_file": "data/MAD_TSC/m2m12B/from_en_to_nl/test.jsonl",
    ...
    },
    {
        ...
        "validation_file": "data/MAD_TSC/m2m12B/from_en_to_pt/test.jsonl",
    ...
    },
    {
        ...
        "validation_file": "data/MAD_TSC/m2m12B/from_en_to_ro/test.jsonl",
        "ckpt_path": "experiments/run_outputs/ro_bert_roman/validation_loss_sg/relaxed_lamarr#validation_loss_sg=0.7808.ckpt",
    },
]

final_results_dir = "experiments/MT_to_languages_eval_collated_results"
