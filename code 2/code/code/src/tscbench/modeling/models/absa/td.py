...
def get_model(model_mlm, tokenizer, configuration="default", **kwargs):
    ...
    if configuration == "default":
        parameters = get_model_layers(
            model_mlm=model_mlm,
            tokenizer=tokenizer,
            fusion_layer={"type": "max_pooling", "kwargs": {}},
            representation_layer={"type": "none", "kwargs": {}},
            classification_layer={"type": "categorical", "kwargs": {}},
            loss_layer={"type": "CE", "kwargs": {}}  # Optional, but recommended to pass for consistency
        )
    elif configuration == "ordered":
        parameters = get_model_layers(
            model_mlm=model_mlm,
            tokenizer=tokenizer,
            fusion_layer={"type" : "max_pooling"},
