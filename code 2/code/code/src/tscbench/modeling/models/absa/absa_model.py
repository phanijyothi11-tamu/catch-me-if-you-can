...
def get_model_layers(
    ...
    # Fallback patch for models missing "architectures" in config
    config_dict = core_model.config.to_dict()
    if "architectures" not in config_dict or not config_dict["architectures"]:
        print("[WARN] Missing 'architectures' in model config — falling back to BERT.")
